...
public class Address {
	...
	// / <summary>
	// / extension method for convert ND (with or without NI String) response to
	// address
	// / </summary>
	...
	public static Address Parse(CommandIndicatorBase indicator) {
		...
		if (!indicator.GetRequestCommand().toString().equalsIgnoreCase("ND"))
			return null;
		...
		System.arraycopy(indicator.GetFrameData(),
				indicator.GetParameterOffset() + 2, device.value, 0, 8);
